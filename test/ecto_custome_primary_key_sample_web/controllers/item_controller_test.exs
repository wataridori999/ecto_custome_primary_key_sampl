defmodule EctoCustomePrimaryKeySampleWeb.ItemControllerTest do
  use EctoCustomePrimaryKeySampleWeb.ConnCase

  alias EctoCustomePrimaryKeySample.Items

  @create_attrs %{category: "some category", item_code: "some item_code", name: "some name"}
