...
# EctoCustomePrimaryKeySampleWeb.Endpoint.init/2 when load_from_system_env is
...
# start per endpoint:
#
#     config :ecto_custome_primary_key_sample, EctoCustomePrimaryKeySampleWeb.Endpoint, server: true
#
...
config :ecto_custome_primary_key_sample, EctoCustomePrimaryKeySample.Repo,
  ...
  username: "postgres",
  password: "postgres",
  database: "ecto_custome_primary_key_sample_dev",
  pool_size: 15
